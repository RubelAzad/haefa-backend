            ...
            <div class="card card-custom" style="padding-bottom: 100px !important;">
                <div class="card-body">
                    ...
                    <form id="generate_barcode_form" method="POST">
                        ...
                        <div class="" id="select-barcode-range" >
                            ...
                            <div class="form-group col-md-2" style="padding-top: 22px;">
                                <button type="button" class="btn btn-primary btn-sm" id="save-btn"> Generate</button>
                            </div>
...
@push('script')
    ...
    <script>
        ...
        {{--    let form = document.getElementById('generate_barcode_form');--}}
        {{--    let formData = new FormData(form);--}}
        {{--    let url = "{{route('barcodeprint.store.or.update')}}";--}}
        ...
        function generatePDF(data) {
                ...
                if (barcodes && barcodes.length > 0) {
                    ...
                    $.each(barcodes, function (index, barcode) {
                        ...
                        if (mdataBarcodePrefixNumber) {
                            let barcodeHTML =
                                '<div class="col-lg-6" style="margin-bottom:42px">' +
                                ...
                                '<p class="ms-1 mb-0 mx-auto text-center" style="font-size: 10px">HEALTH AND EDUCATION FOR ALL (HAEFA)</p>' +
                                '</div>' +
            ...
            }).from($('#barcode-section')[0]).save();

            // var element = document.getElementById('barcode-section');
            // html2pdf(element, {
            //     margin:       1,
            //     filename:     'myfile.pdf',
            ...
            //         filename: 'dynamic_content.pdf',
            //         image: { type: 'png', quality: 1 },
            //         html2canvas: { scale: 1 }, // Adjust the scale value if needed
            //         jsPDF: { unit: 'px', format: 'a4', orientation: 'portrait' }
            //     })
            //     .from($('#barcode-section')[0])
            //     .toContainer()
            //     .toCanvas()
            //     .then((canvas) => {
            //         const imgData = canvas.toDataURL('image/png');
            //         const pdfWidth = 400; // Set the desired width in pixels
            //         const pdfHeight = 200; // Set the desired height in pixels
            //
            //         const pdf = new jsPDF({
            //             unit: 'px',
            ...
            //
            //     pdf.addImage(imgData, 'PNG', 15, 15, 1110, 381);
            //     pdf.save('dynamic_content.pdf');
            // });
        ...
        $('#save-printButton').on('click', function () {
            ...
            // };
            //
            // var temp = document.getElementById("barcode-section");
            //
            ...
            // const myDiv = document.getElementById("barcode-section");
            // console.log(myDiv)
            //
            // html2canvas(myDiv, {
            //
            ...
            //         const pdf = new jsPDF();
            //         pdf.addImage(canvasData, "PNG", 0, 0, canvasWidth, canvasHeight, "", "");
            //         pdf.save("myPdf.pdf");
            //     }
            // });
        ...
        // function generatePDFDocument(barcodeDefinitions) {
        //     // Create a new PDF document
        //     var doc = new jsPDF();
        //
        //
        //     // Loop through the barcode definitions and add them to the PDF
        //     for (var i = 0; i < barcodeDefinitions.length; i++) {
        //         var barcodeDefinition = barcodeDefinitions[i];
        //
        //         // Add the barcode image to the PDF
        //         doc.addImage(
        //             barcodeDefinition.image,
        //             'PNG',
        //             10,
        //             10 + (i * 60), // Adjust the vertical position based on the barcode height
        //             barcodeDefinition.width,
        //             barcodeDefinition.height
        //         );
        //
        //         // Add a page break after printing 10 barcodes
        //         if ((i + 1) % 10 === 0 && i !== barcodeDefinitions.length - 1) {
        //             doc.addPage();
        //         }
        //     }
        //
