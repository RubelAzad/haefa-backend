...
@include('refgender::view-modal')
@include('refgender::add-edit-modal')
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('refgender.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            @if (permission('refgender-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('refgender.store.or.update')}}";
        let id = $('#CCId').val();
        let method;
        if (id) {
            method = 'update';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#view_modal .modal-title').html(
                        '<i class="fas fa-eye"></i> <span>Refgender</span>');
                },
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('refgender.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('refgender.bulk.delete')}}";
...
$(document).on('click', '.change_status', function () {
    ...
    let name  = $(this).data('name');
    let row   = table.row($(this).parent('tr'));
    let url   = "{{ route('refgender.change.status') }}";
    Swal.fire({
    ...
    if (id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#GenderCode').val(data.GenderCode);
                ...
                $('#store_or_update_modal .modal-title').html(
                    '<i class="fas fa-edit"></i> <span>Edit Refgender</span>');
