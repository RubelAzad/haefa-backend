...
@include('deviceregistration::modal')
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('deviceregistration.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
                data.name = $("#form-filter #name").val();
                data.deviceId = $("#form-filter #deviceId").val();
                data._token    = _token;
            }
        },
        "columnDefs": [{
        ...
        "buttons": [
            @if (permission('deviceregistration-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('deviceregistration.store.or.update')}}";
    ...
    $(document).on('click', '.edit_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "{{route('deviceregistration.edit')}}",
                type: "POST",
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('deviceregistration.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('deviceregistration.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('deviceregistration.change.status') }}";
        Swal.fire({
